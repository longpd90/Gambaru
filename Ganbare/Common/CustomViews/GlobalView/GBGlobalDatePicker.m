...
@interface GBGlobalDatePicker ()

@property (strong, nonatomic) UIWindow *keyWindow;

@end

@implementation GBGlobalDatePicker
...
- (void)addToolbar {
    ...
    _toolBar.backgroundColor = kGBColorWhite;
    ...
    GBGlobalButton *cancelButton = [[GBGlobalButton alloc]init];
    ...
    GBGlobalButton *doneButton = [[GBGlobalButton alloc]init];
